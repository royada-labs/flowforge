...
import io.tugrandsolutions.flowforge.workflow.policy.ExecutionPolicy;
import io.tugrandsolutions.flowforge.workflow.policy.RetryPolicy;
import io.tugrandsolutions.flowforge.workflow.policy.TimeoutPolicy;
...
class PolicyIntegrationTest {
  ...
  void should_retry_task_on_failure() {
    ...
    WorkflowExecutionPlan plan = WorkflowExecutionPlan.from(
        io.tugrandsolutions.flowforge.workflow.graph.WorkflowGraph.build(List.of(descriptor)));
