...
import org.royada.flowforge.workflow.trace.OpenTelemetryExecutionTracer;
...
public class FlowForgeOpenTelemetryAutoConfiguration {
    ...
    /**
     * Creates OpenTelemetry auto-configuration instance.
     */
    public FlowForgeOpenTelemetryAutoConfiguration() {
    }

    /**
     * Creates an {@link ExecutionTracerFactory} backed by OpenTelemetry spans.
     *
     * @param openTelemetry OpenTelemetry facade provided by the application context
     * @return tracer factory creating {@link OpenTelemetryExecutionTracer} instances
     */
    @Bean
    ...
    public ExecutionTracerFactory openTelemetryExecutionTracerFactory(OpenTelemetry openTelemetry) {
        Tracer tracer = openTelemetry.getTracer("org.royada.flowforge");
