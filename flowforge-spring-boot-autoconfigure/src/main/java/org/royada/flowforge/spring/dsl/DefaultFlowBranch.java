...
/**
 * Default {@link FlowBranch} implementation backed by an internal branch graph.
 */
public final class DefaultFlowBranch implements FlowBranch {
    ...
    /**
     * Creates a branch implementation bound to the provided graph and root builder.
     *
     * @param branchGraph branch graph
     * @param builder root flow builder
     * @param referenceResolver method-reference resolver
     */
    ...
    private final class BranchFlowBuilder implements FlowBuilder {
        ...
        @Override
        public org.royada.flowforge.workflow.plan.WorkflowExecutionPlan build() {
