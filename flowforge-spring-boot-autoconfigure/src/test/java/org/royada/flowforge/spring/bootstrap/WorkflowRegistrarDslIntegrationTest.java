...
class WorkflowRegistrarDslIntegrationTest {
    ...
    static class DslWorkflowConfig {
        ...
        WorkflowExecutionPlan apiScoreWorkflow(FlowDsl dsl) {
            ...
            return dsl.startTyped(org.royada.flowforge.task.TaskDefinition.of("A", Void.class, Integer.class))
                    .then(org.royada.flowforge.task.TaskDefinition.of("B", Integer.class, Integer.class))
                    .then(org.royada.flowforge.task.TaskDefinition.of("C", Integer.class, String.class))
                    .build();
        }
